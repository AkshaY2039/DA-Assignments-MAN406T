...
GNBClf = GaussianNB()
GNBClf = GNBClf.fit (dataAttributes, dataClass)
print ("Classifier training Finished\n")

classPred = GNBClf.predict (testDataAttributes)
...
classPredSingle = GNBClf.predict (record)
print ("Predicted Class Label: ")
print (classPredSingle)
print ("Actual Class Label : ")
print (checkDataClass[randomIndex])

# partial update in Model
print ("Updated Classifier training Started")
updGNBClf = GaussianNB()
updGNBClf = updGNBClf.fit (dataAttributes, dataClass, numpy.unique (checkDataClass))
print ("Updated Classifier training Finished\n")

classPred = updGNBClf.predict (testDataAttributes)
totalPoints = float (testDataAttributes.shape[0])
mislabeled = float ((checkDataClass == classPred).sum())

print ("Number of mislabeled points out of total %d points : %d" % (totalPoints, mislabeled))
print ("Updated Classifier Model Accuracy: ", (1 - (mislabeled / totalPoints)) * 100.0)
...
print (record)
record = record.reshape (1, -1)
classPredSingle = updGNBClf.predict (record)
print ("Predicted Class Label: ")
print (classPredSingle)
print ("Actual Class Label : ")
print (checkDataClass[randomIndex])